...
-- Get point combinations that are not on the same line, not in the same partition, and within buffersize distance of each other
...
FROM	SCHEMANAME.apoints_b ab
	...
	AND a.eid <> ab.eid
	AND a.lid <> ab.lid
	AND a.PARTITIONNAME <> ab.PARTITIONNAME
